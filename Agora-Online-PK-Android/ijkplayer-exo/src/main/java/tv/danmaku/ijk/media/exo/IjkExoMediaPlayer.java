...
public class IjkExoMediaPlayer extends AbstractMediaPlayer {
    ...
    private class DemoPlayerListener implements DemoPlayer.Listener {
        ...
        public void onStateChanged(boolean playWhenReady, int playbackState)
        {
            ...
            Log.e("wbsTest-->", "onStateChanged, playWhenReady:" + playWhenReady + "    playbackState:" + playbackState);
            if (mIsBuffering) {
        ...
        {
            Log.e("wbsTest-->", "onError=" + e.toString());
        ...
        {
            Log.e("wbsTest-->", "onVideoSizeChanged width:" + width + "    height:" + height);
            mVideoWidth = width;
            mVideoHeight = height;
